...
function getTeamString() {
  var str = "";
  var playerInfoDivs = document.getElementsByClassName(
...
function getGames() {
  ...
  var url =
    "https://www.sportswzrd.com/gamesremaining/?pageName=test&" +
    teamsString +
    "&format=json&date=" +
    dateString +
    "&" +
...
function renderGames(data) {
  ...
  var table = document.getElementsByClassName(
    "Table Ta-start Fz-xs Table-mid Table-px-xs Table-interactive"
  )[0];
  var rows = table.rows;
